...
def calculate_stock_data(data):
    ...
    because we know our stock columns will always have 5 items
    in them this expression could work too:

    sum(int_column) / 5

    however the way weve done it here is using length when the
    length of the list may vary
    """
